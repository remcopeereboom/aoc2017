...
# after program completion as well as the largest value ever stored in the    #
# registry while the program was running.                                     #
#                                                                             #
...
puts "The largest value ever in a register was: #{e.register.max_value}"
