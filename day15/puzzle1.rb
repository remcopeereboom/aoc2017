...
module Duel
  def self.generator(state, factor, divisor)
    Enumerator.new do |y|
      loop do
  ...
  def self.judge(a, b, n = 40_000_000)
...
generator_a = Duel.generator(a_state, a_factor, a_divisor)
generator_b = Duel.generator(b_state, b_factor, b_divisor)
