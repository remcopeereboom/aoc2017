...
# move directions from standard input and prints the maximum number of steps  #
# from the origin at any point during the journey.                            #
#                                                                             #
...
def max_distance_during_journey(istream)
  position = CubeCoord.origin
  max_distance = 0

  directions_from(istream)
    .lazy.map { |dir| DIRECTION_TO_CUBE_COORD[dir] }
    .each do |dir|
...
puts max_distance_during_journey(ARGF)
